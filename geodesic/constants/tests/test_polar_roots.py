...
def test_polar_sc_inclined_circular():
    ...
    x = 0.5
    zp_ch, zm_ch = polar_roots(aa, slr, ecc, x, digits)
    zm = mpf("0.86602540378443864676372317075293618347140262690519031402790348972596\
65084544000185405730933786242878378130707077033515149849725475")
    zp = mpf("3.46410161513775458705489268301174473388561050762076125611161395890386\
...
def test_polar_kerr_inclined_circular():
    ...
    zm = mpf("0.86602540378443864676372317075293618347140262690519031402790348972596\
65084544000185405730933786242878378130707077033515149849725475")
    zp = mpf("3.05543106615531533387676777007068231105836775333459432935070506527093\
...
def test_polar_kerr_circular_equatorial():
    ...
    zp_ch, zm_ch = polar_roots(aa, slr, ecc, x, digits)
    zm = mpf("0")
    zp = mpf("2.81576412442877462061915538563996125884423339096478120511885059807601\
...
def test_polar_sc_inclined_low_ecc():
    ...
    zm = mpf("0.86602540378443864676372317075293618347140262690519031402790348972596\
65084544000185405730933786242878378130707077033515149849725475")
    zp = mpf("3.46988959179744133351400773640924026761245476148250978303554387894263\
...
def test_polar_sc_equatorial_medium_ecc():
    ...
    zp_ch, zm_ch = polar_roots(aa, slr, ecc, x, digits)
    zm = mpf("0")
    zp = mpf("3.61813613493316347176174480364074910973864204973384028770038052303616\
...
def test_polar_sc_high_ecc():
    ...
    zm = mpf("0.86602540378443864676372317075293618347140262690519031402790348972596\
65084544000185405730933786242878378130707077033515149849725475")
    zp = mpf("4.24242858159851701578554748323491974415361125635078536064052378598976\
...
def test_polar_kerr_high_ecc():
    ...
    zm = mpf("0.86602540378443864676372317075293618347140262690519031402790348972596\
65084544000185405730933786242878378130707077033515149849725475")
    zp = mpf("3.35955032142178191259340651151541677850998771597977762887568936095924\
...
def test_radial_kerr_even_higher_ecc():
    ...
    zm = mpf("0.86602540378443864676372317075293618347140262690519031402790348972596\
65084544000185405730933786242878378130707077033515149849725475")
    zp = mpf("3.35962035833558760981616667672183996231036459406120123792348715934372\
